...
All interactive elements across the three chart pages SHALL have a minimum clickable area of 44x44 CSS pixels. Elements affected: `anchor-btn` in `wc2026-groups.html`, `date-tab` in `wc2026-schedule.html`, and `cnav-btn` in the mobile view of `wc2026-bracket.html`.
