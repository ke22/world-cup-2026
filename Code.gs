...
function initializeMatches() {
  ...
  const data = [
    ...
    [3,  '2026-06-13', '03:00', '小組賽', 'B', 1, 'CAN', '加拿大', '🇨🇦', 'BIH', '波士尼亞',   '🇧🇦', '', '', 'upcoming', 'BMO Field',                          '多倫多'],
    ...
    [26, '2026-06-19', '03:00', '小組賽', 'B', 2, 'SUI', '瑞士',   '🇨🇭', 'BIH', '波士尼亞',   '🇧🇦', '', '', 'upcoming', 'SoFi Stadium',                       '洛杉磯'],
    ...
    [49, '2026-06-25', '03:00', '小組賽', 'B', 3, 'BIH', '波士尼亞','🇧🇦','QAT', '卡達',       '🇶🇦', '', '', 'upcoming', 'Lumen Field',                        '西雅圖'],
